    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-16 bg-[#fcfaf8]">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 tracking-tight">Welcome Back</h1>
          <p className="text-gray-500 text-sm mt-2">Sign in to access your account, orders, and more.</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          ...
          <Link href="/account/signup" className="font-bold text-[#D4AF37] hover:underline">
            Create Account
          </Link>
        </p>
      </div>
